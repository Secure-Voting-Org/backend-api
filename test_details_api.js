...
const testDetails = async () => {
    try {
        ...
        const listRes = await axios.get('http://localhost:8081/api/admin/pending-voters');
        ...
        // 2. Get Details
        const detailRes = await axios.get(`http://localhost:8081/api/admin/pending-voter/${appId}`);
